...
model.fit( train_matrix , train_labels , nb_epoch=20, batch_size=16)
...
model.fit( train_sequences , train_labels , nb_epoch=20, batch_size=16)
...
model.add_node(Dropout(0.2), name='dropout_embedding', input='embedding')
for n_gram in [3, 5, 7]:
...
model.add_node(Dropout(0.2), name='dropout', inputs=['flat_' + str(n) for n in [3, 5, 7]])
...
model.fit({'input': train_sequences, 'output': train_labels}, batch_size=16, nb_epoch=20)
...
model.add_node(Dropout(0.2), name="dropout1", input='forward1')
...
model.add_node(Dropout(0.2), name="dropout2", input='backward1') 
...
model.add_node(Dropout(0.2), name='dropout', inputs=['forward2', 'backward2'])
...
model.fit( train_rep , train_labels , nb_epoch=20, batch_size=16)
