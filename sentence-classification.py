...
model.add(LSTM(output_dim=embeddings_dim , activation='tanh', inner_activation='tanh', return_sequences=True, init='zero'))
model.add(Dropout(0.125))
model.add(LSTM(output_dim=embeddings_dim , activation='tanh', inner_activation='tanh', init='zero'))
model.add(Dropout(0.125))
model.add(Dense(1))
