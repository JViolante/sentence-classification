...
model.fit( train_matrix , train_labels , nb_epoch=10, batch_size=16, show_accuracy=False)
...
model.fit( train_sequences , train_labels , nb_epoch=10, batch_size=16, show_accuracy=False )
...
model.fit({'input': train_sequences, 'output': train_labels}, batch_size=16, nb_epoch=10, show_accuracy=False)
results = model.predict_classes( test_sequences )
print ("Accuracy = " + repr( sklearn.metrics.accuracy_score( test_labels , results )  ))
print (sklearn.metrics.classification_report( test_labels , results ))
...
model.add_node(Dropout(0.25), input='forward1')
...
model.add_node(Dropout(0.25), input='backward1') 
...
model.fit( train_rep , train_labels , nb_epoch=10, batch_size=16, show_accuracy=False)
