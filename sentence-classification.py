...
model.add(LSTM(output_dim=embeddings_dim , activation='relu', return_sequences=True, init='he_uniform'))
model.add(Dropout(0.1))
model.add(LSTM(output_dim=embeddings_dim , activation='relu', init='he_uniform'))
model.add(Dense(1,init='he_uniform',activation='linear'))
